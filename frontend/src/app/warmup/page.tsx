...
import { useWarmupTrainings } from '@/hooks/useFlexibilityChecks';
...
export default function WarmupPage() {
  const { trainings, loading, error } = useWarmupTrainings();
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold">ウォームアップ</h1>
      </div>
      <div className="mb-8">
        <p className="text-gray-700 mb-4">
          このページでは、テニス選手のパフォーマンス向上とケガ予防のためのウォームアップメニューを確認できます。
        </p>
